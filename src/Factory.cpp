...
/*   Updated: 2018/04/16 15:07:32 by stmartin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	int static min = std::numeric_limits<char>::min();
	int static max = std::numeric_limits<char>::max();
...
{
	int static min = std::numeric_limits<short int>::min();
	int static max = std::numeric_limits<short int>::max();
...
{
	int static min = std::numeric_limits<int>::min();
	int static max = std::numeric_limits<int>::max();
...
{
	float static minf = -std::numeric_limits<float>::max();
	float static maxf = std::numeric_limits<float>::max();
...
{
	double static mind = -std::numeric_limits<double>::max();
	double static maxd = std::numeric_limits<double>::max();
